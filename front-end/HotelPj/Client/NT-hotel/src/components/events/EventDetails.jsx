  ...
  const data = [
    {
      ...
      header: "Tiệc cuối năm tại Caravelle",
      description:
    ...
    },
    {
      ...
      header: "TIỆC CƯỚI TẠI CARAVELLE",
      description:
    ...
    <section>
      <div style={{ width: "70%", margin: "auto" }}>
        <img
          ...
          style={{ width: "100%" }}
        />
        <h2 className="events-header">KHÔNG GIAN TIỆC TRÊN TẦNG 26</h2>
        <p className="events-header-description">
          ...
          bằng một bức tường có thể thu vào.
        </p>
        <hr></hr>
        <h2 className="events-header">KHÔNG GIAN</h2>
        <p className="events-header-description">
        ...
        <div>
          <a href="" className="events-details-buttons">
            BROCHUE
          </a>
        </div>
        <em className="events-em">
          * Khu vực không cho phép trẻ em dưới 15 tuổi tham dự
        </em>
        <div className="event-details-images">
          <img
            src="https://www.caravellehotel.com/wp-content/uploads/Events-on-26-offer7.jpg"
            alt=""
          ></img>
          <img
            src="https://www.caravellehotel.com/wp-content/uploads/Events-on-26-offer3.jpg"
            alt=""
          ></img>
          <img
            src="https://www.caravellehotel.com/wp-content/uploads/Events-on-26-offer8.jpg"
            alt=""
          ></img>
          <img
            src="https://www.caravellehotel.com/wp-content/uploads/Events-on-26-offer5.jpg"
            alt=""
          ></img>
          <img
            src="https://www.caravellehotel.com/wp-content/uploads/Events-on-26-offer4-1.jpg"
            alt=""
          ></img>
          <img
            src="https://www.caravellehotel.com/wp-content/uploads/Events-on-26-offer6.jpg"
            alt=""
          ></img>
        </div>
      </div>
